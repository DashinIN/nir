                ...
                {sampleData && (
                    <VStack gap={16}>
                        <HStack max justify='between'>
                            ...
                            <Button size='large' type='primary'  onClick={handleBack}>К списку шаблонов</Button>
                        </HStack>
                        ...
                        {isEdit && (
                            <HStack max justify='center' gap={8}>
                                <Button size='large'  onClick={handleCancel}>Отменить изменения</Button>
                                <Button size='large' type='primary' onClick={handleSave}>Сохранить</Button>
                            </HStack>
                        )}
                    </VStack>
                )}
